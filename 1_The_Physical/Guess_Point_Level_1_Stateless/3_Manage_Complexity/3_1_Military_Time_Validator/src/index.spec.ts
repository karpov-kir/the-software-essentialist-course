...
describe(TimeValidator, () => {
  ...
  describe('invalid time', () => {
    it('tells that "15:30 - 15:30" is not valid military time range', () => {
    ...
    describe('invalid time because of hours', () => {
      ...
      it('tells that "15:30 - 14:30" is not valid military time range', () => {
        expect(timeValidator.isValidMilitaryTimeRange('15:30 - 14:30')).toBeFalsy();
      });
    });
    ...
    describe('invalid time because of minutes', () => {
      ...
      it('tells that "15:30 - 15:25" is not valid military time range', () => {
        expect(timeValidator.isValidMilitaryTimeRange('15:30 - 15:25')).toBeFalsy();
      });
    });
  });
});
